...
class TaskRunner:
    ...
    def run(self, config):
        ...
        reward_fn = load_reward_manager(
            config, tokenizer, num_examine=0, is_eval=False, **config.reward_model.get("reward_kwargs", {})
        )
        val_reward_fn = load_reward_manager(
            config, tokenizer, num_examine=1, is_eval=True, **config.reward_model.get("reward_kwargs", {})
        )

       #  val_reward_fn = SearchValManager(tokenizer=tokenizer, num_examine=2)
